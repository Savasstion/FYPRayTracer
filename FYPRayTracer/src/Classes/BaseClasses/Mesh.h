...
struct Mesh
{
    ...
    static void ProcessNode(const aiNode* node, const aiScene* scene, std::vector<Vertex>& vertices,
                            std::vector<uint32_t>& indices);
    static void GenerateMesh(const std::string& filepath, std::vector<Vertex>& outVertices,
